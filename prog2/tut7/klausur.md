...
* Die Methode ``getAllContactPersonNamesSortedFromCompaniesLocatedInSouth()`` soll alle Namen der Kontaktpersonen ohne Dopplungen absteigend sortiert zurückgeben.
