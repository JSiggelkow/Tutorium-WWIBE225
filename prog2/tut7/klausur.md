...
* Die Methode ``getAllContactPersonNamesSortedFromCompaniesLocatedInSouth()`` soll alle Namen der Kontaktpersonen im Süden ohne Dopplungen absteigend sortiert zurückgeben.
