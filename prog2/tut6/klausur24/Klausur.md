...
der Methode void playCard (row: int) mit der Karte Zombie sowie der Reihe 1 die Ausnahme NotEnoughActionPointsException ausgelöst wird (3,5 Punkte)
...
* Die Methode void printCityWithMostPoints0f Interest() soll die Stadt mit den meisten Sehenswürdigkeiten in der Form [Name der Stadt] ([Anzahl Sehenswürdigkeiten]) ausgeben (4 Punkte)
